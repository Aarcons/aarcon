...
<script>
  ...
  <body>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="input-group col-md-5 pl-0 pr-0">
                                                        <div class="input-group append" >
                                                            <input type="password" name="olpass" class="form-control" id="olpass" required pattern="^(?=.*\d).{4,8}$">
                                                            <a href="#" onclick="show2Function()"><i class="form-control fas fa-eye" aria-hidden="true"></i></a>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="input-group col-md-5 pl-0 pr-0">
                                                        <div class="input-group append">
                                                            <input type="password" name="newpass" class="form-control" id="newpass" required pattern="^(?=.*\d).{4,8}$" oninvalid="this.setCustomValidity('Password must be 4-8 character long, atleast 1 number required')" oninput="this.setCustomValidity('')">
                                                            <a href="#" onclick="show3Function()"><i class="form-control fas fa-eye"></i></a>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="input-group col-md-5 pl-0 pr-0">
                                                        <div class="input-group append">
                                                            <input type="password" name="conpassrs" class="form-control" id="conpassrs" required pattern="^(?=.*\d).{4,8}$">
                                                            <a href="#" onclick="show4Function()"><i class="form-control fas fa-eye"></i></a>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="accbtnrow clearfix">
                                                    <div class="form-group row accbtnrow2">
                                                        <button type="submit" name="rspassbtn" id="checkpass" class="btn">Update</button>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
    ...
    <script type="text/javascript">
      function show2Function(){
        var show2 = document.getElementById("olpass");
      ...
      function show3Function(){
        var show3 = document.getElementById("newpass");
        event.preventDefault();
       ...
       function show4Function(){
        var show4 = document.getElementById("conpassrs");
        event.preventDefault();
        if (show4.type === "password") {
            show4.type = "text";
        } 
        else {
            show4.type = "password";
        ...
        var passwordrs = document.getElementById("newpass")
        , confirm_passwordrs = document.getElementById("conpassrs");
        function validatePasswordrs(){
          if(passwordrs.value != confirm_passwordrs.value){
            confirm_passwordrs.setCustomValidity("Passwords Don't Match");
          } else {
            confirm_passwordrs.setCustomValidity('');
          }
        }
        passwordrs.onchange = validatePasswordrs;
        confirm_passwordrs.onkeyup = validatePasswordrs;
    </script>
    <script type="text/javascript">
