...
<html lang="en">
    <head>
        ...
        <meta name="description" content="<b>At Aarcons</b> we provide <b>migration certificate</b> service for students of MP. We help students of MP to get migration certificate very fast.">
  <meta property="og:title" content="Migration Certificate - Aarcons" >
  <meta property="og:url" content="https://aarcons.com" >
  <meta property="og:type" content="website" >
  <meta property="og:description" content="<b>At Aarcons</b> we provide <b>migration certificate</b> service for students of MP. We help students of MP to get migration certificate very fast." >
  <meta property="og:image" content="images/aarcons.png" >
  <meta name="keywords" content="migration certificate, application for migration certificate, online migration certificate, migration certificate apply online, online migration certificate, original migration certificate, apply migration certificate, aarcons, aarcons consultancy, aarambh consultancy services">
  ...
  gtag('config', 'G-0PWJWQKF7C');
    ...
    <body>
            ...
            <div class="container" id="enq-maincont">
                <div class="row">
                    <div class="form-cont-enq col-12">
                        <h3 class="text-center pt-3"><b>Migration Certificate</b></h3>
                        <form method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group row d-flex justify-content-center pl-3 pr-3 pl-md-0 pr-md-0">
                                <label class="col-md-2 pl-0 pl-md-3" for="fname-mig">First Name *</label>
                                <input type="text" name="fname-mig" id="fname-mig" class=" col-md-3 form-control" required>
                                <label class="col-md-2 pl-0 pl-md-3" for="lname-mig">Last Name *</label>
                                <input type="text" name="lname-mig" id="lname-mig" class="col-md-3 form-control" required>
                            </div>
                            <div class="form-group row d-flex justify-content-center pl-3 pr-3 pl-md-0 pr-md-0">
                                <label class="col-md-2 pl-0 pl-md-3" for="dob-mig">Date of Birth *</label>
                                <input type="text" name="dob-mig" id="dob-mig" class="col-md-3 form-control" pattern="^(0[1-9]|[12][0-9]|3[01])[- /.](0[1-9]|1[012])[- /.](19|20)\d\d$" required>
                                <label class="col-md-2 pl-0 pl-md-3" for="mob-mig">Mobile No. *</label>
                                <input type="text" name="mob-deg" id="mob-mig" class="col-md-3 form-control" pattern="^(?:(?:\+|0{0,2})91(\s*[\-]\s*)?|[0]?)?[789]\d{9}$" required>
                            </div>
                            <div class="form-group row d-flex justify-content-center pl-3 pr-3 pl-md-0 pr-md-0">
                                <label class="col-md-2 pl-0 pl-md-3" for="cat-mig">Category *</label>
                                <select class="col-md-3 form-control" name="cat-mig" required>
                                ...
                                <label class="col-md-2 pl-0 pl-md-3" for="add-mig">Address *</label>    
                                <input type="text" name="add-mig" id="add-mig" class="col-md-3 form-control" required>
                            </div>
                            <h4 class="text-center mb-3">College Detail</h4>
                            <div class="form-group row d-flex justify-content-center pl-3 pr-3 pl-md-0 pr-md-0">
                                <label class="col-md-2 pl-0 pl-md-3" for="cname-mig">Course Name *</label>
                                <select class="col-md-3 form-control" name="cname-mig" required>
                                ...
                                <label class="col-md-2 pl-0 pl-md-3" for="ename-mig">Exam Name *</label>
                                <input type="text" name="ename-mig" id="ename-mig" class="col-md-3 form-control" required>
                            </div>
                            <div class="form-group row d-flex justify-content-center pl-3 pr-3 pl-md-0 pr-md-0">
                                <label class="col-md-2 pl-0 pl-md-3" for="eyear-mig">Last Exam Year *</label>
                                <select class="col-md-3 form-control" name="eyear-mig" required>
                                ...
                                <label class="col-md-2 pl-0 pl-md-3" for="rno-mig">Roll No. *</label>
                                <input type="text" name="rno-mig" id="rno-mig" class="col-md-3 form-control" required>
                            </div>
                            <div class="form-group row d-flex justify-content-center pl-3 pr-3 pl-md-0 pr-md-0">
                                <label class="col-md-2 pl-0 pl-md-3" for="erno-mig">Enrollment No. *</label>
                                <input type="text" name="erno-mig" id="erno-mig" class="col-md-3 form-control" required>
                                <label class="col-md-2 pl-0 pl-md-3" for="rp-mig">Regular/ Private *</label>
                                <select class="col-md-3 form-control" name="rp-mig" required>
                            ...
                            <div class="form-group row d-flex justify-content-center pl-3 pr-3 pl-md-0 pr-md-0">
                                <label class="col-md-2 pl-0 pl-md-3" for="eresult-mig">Exam Result *</label>
                                <select class="col-md-3 form-control" name="eresult-mig" required>
                                    <option disabled selected value="">Select</option>
                                    <option value="pass">Pass</option>
                                    <option value="fail">Fail</option>
                                </select>
                                <label class="col-md-2 pl-0 pl-md-3">Exam Center Name *</label>
                                <select class="col-md-3 form-control" name="ecenter-mig" required>
                                    <option disabled selected value="">Select</option>
                            ...
                            <h4 class="text-center mb-3">Migration Certificate Details</h4>
                            <div class="form-group row d-flex justify-content-center pl-3 pr-3 pl-md-0 pr-md-0">
                                <label class="col-md-3 pl-0 pl-md-3" for="any-mig">Please Select Any One (If Applicable)</label>
                                <div class="input-group col-md-4 pl-0 pr-0">
                                    <div class="input-group-append">
                                        <select name="cen-nm-mig" class="form-control col-5">
                                        ...
                                        <div class="custom-file col-7 overflow-hidden">
                                            <input type="file" name="any-mig" class="custom-file-input" id="any-mig">
                                            <label class="custom-file-label" for="any-mig">..</label>
                                        </div>
                                    </div>    
                                </div>
                            ...
                            <div class="form-group row d-flex justify-content-center pl-3 pr-3 pl-md-0 pr-md-0">
                                <label class="col-md-3 pl-0 pl-md-3" for="mark-mig">Upload Marksheet *</label>
                                <div class="custom-file col-md-4 overflow-hidden">
                                    <input type="file" name="mark-mig" class="custom-file-input" id="mark-mig" required>
                                    <label class="custom-file-label" for="mark-mig">Choose File</label>
                                </div>
                                <label class="col-md-3 pl-0 pl-md-3 text-danger">PDF (Max Size 200 KB)</label>
                            </div>
                            <div class="form-group row d-flex justify-content-center pl-3 pr-3 pl-md-0 pr-md-0">
                                <label class="col-md-3 pl-0 pl-md-3" for="tc-mig">Upload Transfer Certificate *</label>
                                <div class="custom-file col-md-4 overflow-hidden">
                                    <input type="file" name="tc-mig" class="custom-file-input" id="tc-mig" required>
                                    <label class="custom-file-label" for="tc-mig">Choose File</label>
                                </div>
                                <label class="col-md-3 pl-0 pl-md-3 text-danger">PDF (Max Size 200 KB)</label>
                            </div>
                            <div class="btn-div-enq pb-5 pt-3 d-flex justify-content-center">
                                <button type="submit" class="btn sb-btn" name="migration">Submit</button>
                                <button type="reset" class="btn rs-btn ml-3" name="rs-mig">Reset</button>
                            </div>
                        </form>
                    </div>
                </div>
        ...
        <script type="text/javascript">
            ...
            $(function() {
            $("#dob-mig").datepicker({ dateFormat: 'dd/mm/yy' });
            });
        </script>
    </body>
</html>
