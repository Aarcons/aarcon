...
<html lang="en">
    <head>
        ...
        <title>Duplicate Marksheet</title>
        ...
        <meta name="description" content="<b>At Aarcons</b> we provide <b>duplicate marksheet</b> service for students of MP. We help students of MP to get duplicate marksheet very fast.">
  <meta property="og:title" content="Duplicate Marksheet - Aarcons" >
  <meta property="og:url" content="https://aarcons.com" >
  <meta property="og:type" content="website" >
  <meta property="og:description" content="<b>At Aarcons</b> we provide <b>duplicate marksheet</b> service for students of MP. We help students of MP to get duplicate marksheet very fast." >
  <meta property="og:image" content="images/aarcons.png" >
  <meta name="keywords" content="duplicate marksheet, duplicate marksheet correction, aarcons, aarcons consultancy, aarambh consultancy services">
  ...
  gtag('config', 'G-0PWJWQKF7C');
    ...
    <body>
            ...
            <div class="container" id="enq-maincont">
                <div class="row">
                    <div class="form-cont-enq col-12">
                        <h3 class="text-center pt-3"><b>Duplicate Marksheet</b></h3>
                        <form method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group row d-flex justify-content-center pl-3 pr-3 pl-md-0 pr-md-0">
                                <label class="col-md-2 pl-0 pl-md-3" for="fname-dmark">First Name *</label>
                                <input type="text" name="fname-dmark" id="fname-dmark" class=" col-md-3 form-control" required>
                                <label class="col-md-2 pl-0 pl-md-3" for="lname-dmark">Last Name *</label>
                                <input type="text" name="lname-dmark" id="lname-dmark" class="col-md-3 form-control" required>
                            </div>
                            <div class="form-group row d-flex justify-content-center pl-3 pr-3 pl-md-0 pr-md-0">
                                <label class="col-md-2 pl-0 pl-md-3" for="dob-dmark">Date of Birth *</label>
                                <input type="text" name="dob-dmark" id="dob-dmark" class="col-md-3 form-control" pattern="^(0[1-9]|[12][0-9]|3[01])[- /.](0[1-9]|1[012])[- /.](19|20)\d\d$" required>
                                <label class="col-md-2 pl-0 pl-md-3" for="mob-dmark">Mobile No. *</label>
                                <input type="text" name="mob-dmark" id="mob-dmark" class="col-md-3 form-control" pattern="^(?:(?:\+|0{0,2})91(\s*[\-]\s*)?|[0]?)?[789]\d{9}$" required>
                            </div>
                            <div class="form-group row d-flex justify-content-center pl-3 pr-3 pl-md-0 pr-md-0">
                                <label class="col-md-2 pl-0 pl-md-3" for="cat-dmark">Category *</label>
                                <select class="col-md-3 form-control" name="cat-dmark" required>
                                ...
                                <label class="col-md-2 pl-0 pl-md-3" for="add-dmark">Address *</label>    
                                <input type="text" name="add-dmark" id="add-dmark" class="col-md-3 form-control" required>
                            </div>
                            <h4 class="text-center mb-3">College Detail</h4>
                            <div class="form-group row d-flex justify-content-center pl-3 pr-3 pl-md-0 pr-md-0">
                                <label class="col-md-2 pl-0 pl-md-3" for="cname-dmark">Course Name *</label>
                                <select class="col-md-3 form-control" name="cname-dmark" required>
                                ...
                                <label class="col-md-2 pl-0 pl-md-3" for="ename-dmark">Exam Name *</label>
                                <input type="text" name="ename-dmark" id="ename-dmark" class="col-md-3 form-control" required>
                            </div>
                            <div class="form-group row d-flex justify-content-center pl-3 pr-3 pl-md-0 pr-md-0">
                                
                                <label class="col-md-2 pl-0 pl-md-3" for="eyear-dmark">Last Exam Year *</label>
                                <select class="col-md-3 form-control" name="eyear-dmark" required>
                                ...
                                <label class="col-md-2 pl-0 pl-md-3" for="rno-dmark">Roll No. *</label>
                                <input type="text" name="rno-dmark" id="rno-dmark" class="col-md-3 form-control" required>
                            </div>
                            <div class="form-group row d-flex justify-content-center pl-3 pr-3 pl-md-0 pr-md-0">
                                
                                <label class="col-md-2 pl-0 pl-md-3" for="erno-dmark">Enrollment No. *</label>
                                <input type="text" name="erno-dmark" id="erno-dmark" class="col-md-3 form-control" required>
                                <label class="col-md-2 pl-0 pl-md-3" for="rp-dmark">Regular/ Private *</label>
                                <select class="col-md-3 form-control" name="rp-dmark" required>
                            ...
                            <div class="form-group row d-flex justify-content-center pl-3 pr-3 pl-md-0 pr-md-0">
                                ...
                                <label class="col-md-2 pl-0 pl-md-3" for="ecenter-dmark">Exam Center Name *</label>
                                <select class="col-md-3 form-control" name="ecenter-dmark" required>
                                    <option disabled selected value="">Select</option>
                                ...
                                <label class="col-md-2 pl-0 pl-md-3" for="dupsem-dmark">Duplicate Marksheet Sem. *</label>
                                <select class="col-md-3 form-control" name="dupsem-dmark" required>
                                    ...
                                    <option value="9SEM">9SEM</option>
                                    <option value="10SEM">10SEM</option>
                                    <option value="1YRS">1YEAR(PRIVATE)</option>
                                    <option value="2YRS">2YEAR(PRIVATE)</option>
                                    <option value="3YRS">3YEAR(PRIVATE)</option>
                                    <option value="1YEAR">1YEAR</option>
                                    <option value="2YEAR">2YEAR</option>
                                    <option value="3YEAR">3YEAR</option>
                                    <option value="4YEAR">4YEAR</option>
                                    <option value="1PROF">1PROF</option>
                                    <option value="2PROF">2PROF</option>
                                    <option value="3PROF">3PROF</option>
                                    <option value="3PROFP2">3PROF-PART 2</option>
                                    <option value="4PROF">4PROF</option>
                                    <option value="1CW">1CW</option>
                                    <option value="2CW">2CW</option>
                                    <option value="CW">CW</option>
                                </select>
                            </div>
                            <h4 class="text-center mb-3">Duplicate Marksheet Details</h4>
                            <div class="form-group row d-flex justify-content-center pl-3 pr-3 pl-md-0 pr-md-0">
                                <label class="col-md-3 pl-0 pl-md-3" for="any-dmark">Please Select Any One (If Applicable)</label>
                                <div class="input-group col-md-4 pl-0 pr-0">
                                    <div class="input-group-append">
                                        <select name="any-dmark" class="form-control col-5">
                                        ...
                                        <div class="custom-file col-7 overflow-hidden">
                                            <input type="file" name="any-dmark" class="custom-file-input" id="any-dmark">
                                            <label class="custom-file-label" for="any-dmark">..</label>
                                        </div>
                                    </div>    
                                </div>
                            ...
                            <div class="form-group row d-flex justify-content-center pl-3 pr-3 pl-md-0 pr-md-0">
                                <label class="col-md-3 pl-0 pl-md-3" for="mark-dmark">Upload Marksheet *</label>
                                <div class="custom-file col-md-4 overflow-hidden">
                                    <input type="file" name="mark-dmark" class="custom-file-input" id="mark-dmark" required>
                                    <label class="custom-file-label" for="mark-dmark">Choose File</label>
                                </div>
                            ...
                            <div class="btn-div-enq pb-5 pt-3 d-flex justify-content-center">
                                <button type="submit" class="btn sb-btn" name="sb-dmark">Submit</button>
                                <button type="reset" class="btn rs-btn ml-3" name="rs-dmark">Reset</button>
                            </div>
                        </form>
                    </div>
                </div>
        ...
        <script type="text/javascript">
            ...
            $(function() {
            $("#dob-dmark").datepicker({ dateFormat: 'dd/mm/yy' });
            });
        </script>
    </body>
</html>
