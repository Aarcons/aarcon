...
<html lang="en">
    <head>
        ...
        <meta name="description" content="<b>At Aarcons</b> we provide <b>provisonal degree</b> service for students of MP. We help students of MP to get provisional degree very fast.">
  <meta property="og:title" content="Provisional Degree - Aarcons" >
  <meta property="og:url" content="https://aarcons.com" >
  <meta property="og:type" content="website" >
  <meta property="og:description" content="<b>At Aarcons</b> we provide <b>provisional degree</b> service for students of MP. We help students of MP to get provisional degree very fast." >
  <meta property="og:image" content="images/aarcons.png" >
  <meta name="keywords" content="provisional degree, provisional degree certificate, aarcons, aarcons consultancy, aarambh consultancy services">
  ...
  gtag('config', 'G-0PWJWQKF7C');
    ...
    <body>
            ...
            <div class="container" id="enq-maincont">
                <div class="row">
                    <div class="form-cont-enq col-12">
                        <h3 class="text-center pt-3"><b>Provisional Degree</b></h3>
                        <form method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group row d-flex justify-content-center pl-3 pr-3 pl-md-0 pr-md-0">
                                <label class="col-md-2 pl-0 pl-md-3" for="fname-prdeg">First Name *</label>
                                <input type="text" name="fname-prdeg" id="fname-prdeg" class=" col-md-3 form-control" required>
                                <label class="col-md-2 pl-0 pl-md-3" for="lname-prdeg">Last Name *</label>
                                <input type="text" name="lname-prdeg" id="lname-prdeg" class="col-md-3 form-control" required>
                            </div>
                            <div class="form-group row d-flex justify-content-center pl-3 pr-3 pl-md-0 pr-md-0">
                                <label class="col-md-2 pl-0 pl-md-3" for="dob-prdeg">Date of Birth *</label>
                                <input type="text" name="dob-prdeg" id="dob-prdeg" class="col-md-3 form-control" pattern="^(0[1-9]|[12][0-9]|3[01])[- /.](0[1-9]|1[012])[- /.](19|20)\d\d$" required>
                                <label class="col-md-2 pl-0 pl-md-3" for="mob-prdeg">Mobile No. *</label>
                                <input type="text" name="mob-prdeg" id="mob-prdeg" class="col-md-3 form-control" pattern="^(?:(?:\+|0{0,2})91(\s*[\-]\s*)?|[0]?)?[789]\d{9}$" required>
                            </div>
                            <div class="form-group row d-flex justify-content-center pl-3 pr-3 pl-md-0 pr-md-0">
                                <label class="col-md-2 pl-0 pl-md-3" for="cat-prdeg">Category *</label>
                                <select class="col-md-3 form-control" name="cat-prdeg" required>
                                ...
                                <label class="col-md-2 pl-0 pl-md-3" for="add-prdeg">Address *</label>    
                                <input type="text" name="add-prdeg" id="add-prdeg" class="col-md-3 form-control" required>
                            </div>
                            <h4 class="text-center mb-3">College Detail</h4>
                            <div class="form-group row d-flex justify-content-center pl-3 pr-3 pl-md-0 pr-md-0">
                                <label class="col-md-2 pl-0 pl-md-3" for="cname-prdeg">Course Name *</label>
                                <select class="col-md-3 form-control" name="cname-prdeg" required>
                                ...
                                <label class="col-md-2 pl-0 pl-md-3" for="divison-prdeg">Division *</label>
                                <input type="text" name="divison-prdeg" id="divison-prdeg" class="col-md-3 form-control" required>
                            </div>
                            <div class="form-group row d-flex justify-content-center pl-3 pr-3 pl-md-0 pr-md-0">
                                <label class="col-md-2 pl-0 pl-md-3" for="ename-prdeg">Exam Name *</label>
                                <input type="text" name="ename-prdeg" id="ename-prdeg" class="col-md-3 form-control" required>
                                <label class="col-md-2 pl-0 pl-md-3" for="eyear-prdeg">Last Exam Year *</label>
                                <select class="col-md-3 form-control" name="eyear-prdeg" required>
                            ...
                            <div class="form-group row d-flex justify-content-center pl-3 pr-3 pl-md-0 pr-md-0">
                                <label class="col-md-2 pl-0 pl-md-3" for="rno-prdeg">Roll No. *</label>
                                <input type="text" name="rno-prdeg" id="rno-prdeg" class="col-md-3 form-control" required>
                                <label class="col-md-2 pl-0 pl-md-3" for="erno-prdeg">Enrollment No. *</label>
                                <input type="text" name="erno-prdeg" id="erno-prdeg" class="col-md-3 form-control" required>       
                            </div>
                            <div class="form-group row d-flex justify-content-center pl-3 pr-3 pl-md-0 pr-md-0">
                                <label class="col-md-2 pl-0 pl-md-3" for="rp-prdeg">Regular/ Private *</label>
                                <select class="col-md-3 form-control" name="rp-prdeg" required>
                                    <option disabled selected value="">Select</option>
                                    <option value="regular">Regular</option>
                                    <option value="private">Private</option>
                                </select>
                                <label class="col-md-2 pl-0 pl-md-3" for="ecenter-prdeg">Exam Center Name *</label>
                                <select class="col-md-3 form-control" name="ecenter-prdeg" required>
                                    <option disabled selected value="">Select</option>
                            ...
                            <h4 class="text-center mb-3">Provisional Degree Details</h4>
                            <div class="form-group row d-flex justify-content-center pl-3 pr-3 pl-md-0 pr-md-0">
                                <label class="col-md-3 pl-0 pl-md-3" for="any-prdeg">Please Select Any One (If Applicable)</label>
                                <div class="input-group col-md-4 pl-0 pr-0">
                                    <div class="input-group-append">
                                        <select name="any-prdeg" class="form-control col-5">
                                        ...
                                        <div class="custom-file col-7 overflow-hidden">
                                            <input type="file" name="any-prdeg" class="custom-file-input" id="any-prdeg">
                                            <label class="custom-file-label" for="any-prdeg">..</label>
                                        </div>
                                    </div>    
                                </div>
                            ...
                            <div class="form-group row d-flex justify-content-center pl-3 pr-3 pl-md-0 pr-md-0">
                                <label class="col-md-3 pl-0 pl-md-3" for="mark-prdeg">Upload Marksheet *</label>
                                <div class="custom-file col-md-4 overflow-hidden">
                                    <input type="file" name="mark-prdeg" class="custom-file-input" id="mark-prdeg" required>
                                    <label class="custom-file-label" for="mark-prdeg">Choose File</label>
                                </div>
                            ...
                            <div class="btn-div-enq pb-5 pt-3 d-flex justify-content-center">
                                <button type="submit" class="btn sb-btn" name="sb-prdeg">Submit</button>
                                <button type="reset" class="btn rs-btn ml-3" name="rs-prdeg">Reset</button>
                            </div>
                        </form>
                    </div>
                </div>
        ...
        <script type="text/javascript">
            ...
            $(function() {
            $("#dob-prdeg").datepicker({ dateFormat: 'dd/mm/yy' });
            });
        </script>
    </body>
</html>
